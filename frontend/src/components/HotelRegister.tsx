...
const HotelRegister = () => {
  ...
  return (
    <div onClick={() => setShowHotelReg(false)} className="fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70">
      <form onSubmit={onSubmitHandler} onClick={(e) => e.stopPropagation()} className="flex bg-white rounded-xl lg:w-4xl  max-md:mx-2">
        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
          <Image src={assets.closeIcon}
            ...
            alt="close-icon" width={20} height={20} onClick={() => setShowHotelReg(false)} />
          ...
          <div className="w-full mt-4">
            ...
            <input onChange={(e) => setName(e.target.value)} value={name} type="text" id="name" placeholder="Enter your hotel name"
          ...
          <div className="w-full mt-4">
            ...
            <input onChange={(e) => setContact(e.target.value)} value={contact} type="text" id="concat" placeholder="Enter your phone number"
              className="border border-gray-200 rounded w-full px-3 py-2.5 mt--1 outline-indigo-50 font-light" required />
          </div>
          ...
          <div className="w-full mt-4">
            ...
            <input onChange={(e) => setAddress(e.target.value)} value={address} type="text-area" id="address" placeholder="Type your address"
          ...
          <div className="w-full mt-4 max-w-60 mr-auto">
            ...
            <select onChange={(e) => setCity(e.target.value)} value={city} id="city" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-50 font-light">
          ...
          {/* Submit Button */}
          <button type="submit"  className="bg-indigo-500 hover:bg-indigo-600 transition-all text-white px-6 py-2 mt-6 rounded cursor-pointer" >Resister</button>
        </div>
      </form>
    </div>
  );
