    ...
    <div>
      ...
      <div className='flex gap-4 my-8'>
        ...
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          <Image src={assets.totalBookingIcon} alt='total-booking-icon' width={40} height={40} className='max-sm:hidden h-10' />
        ...
        {/* Total Revenue */}
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          <Image src={assets.totalRevenueIcon} alt='total-booking-icon' width={40} height={40} className='max-sm:hidden h-10' />
          <div className='flex flex-col sm:ml-4 font-medium'>
